...
"}")
        ...
        self.progressBar.setGeometry(QRect(100, 270, 471, 23))
...
"}")
        ...
        self.label_3.setGeometry(QRect(0, 310, 661, 21))
        font2 = QFont()
    ...
    def retranslateUi(self, SplashScreen):
        SplashScreen.setWindowTitle(QCoreApplication.translate("SplashScreen", u"COVID-19  Situation Analysis Application", None))
